    ...
    <div className="flex gap-6">
      ...
      <div className="flex-1 space-y-4">
        <div className="rounded-2xl border bg-card/50 backdrop-blur-sm p-6">
          ...
          <p className="text-sm text-muted-foreground mt-1">Управление вашим аккаунтом и предпочтениями</p>
        </div>
        ...
        <div className="rounded-2xl border bg-card/50 backdrop-blur-sm p-6 space-y-6">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">Ваш email используется для входа и получения уведомлений</p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-lg bg-background/50">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Обновите пароль для вашей учетной записи</p>
              </div>
              <Button variant="outline" className="border-primary/30 bg-transparent">
                Изменить
              </Button>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-lg bg-background/50">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Получать уведомления о новых товарах и акциях</p>
              </div>
              <button
