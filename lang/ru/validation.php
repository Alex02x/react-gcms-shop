    ...
    */
    ...
    'custom' => [
        'email' => [
            ...
            'email' => 'Пожалуйста, укажите действительный email адрес',
        ],
        'code' => [
            'required' => 'Необходимо указать код подтверждения',
            'size' => 'Код подтверждения должен состоять ровно из 6 цифр',
            'regex' => 'Код подтверждения должен содержать только цифры',
        ],
    ],
