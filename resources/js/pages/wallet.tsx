...
export default function WalletPage() {
    ...
    const handleTopUp = async () => {
        ...
        setTimeout(() => {
            ...
            alert(
                `Пополнение на ${amount} ₽ через ${paymentMethods.find((m) => m.id === selectedMethod)?.name}`,
            );
        }, 1000);
    };
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-muted-foreground">
                                Пополните баланс и управляйте финансами
                            </p>
                        </div>
                    ...
                    {isLoading ? (
                        <div className="space-y-4">
                            {[...Array(3)].map((_, i) => (
                                <div
                                    key={i}
                                    className="h-28 animate-pulse rounded-2xl border bg-card/50 backdrop-blur-sm"
                                />
                            ))}
                        </div>
                    ) : payments.length === 0 ? (
                                        ...
                                        <div className="flex flex-1 gap-4">
                                            ...
                                            <div className="flex-1 space-y-2">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div
                                                        className={`flex items-center gap-1 text-sm ${getStatusColor(payment.status)}`}
                                                    >
