    ...
    return [
        {
            ...
            rating: 5,
            comment:
                'Отличный модуль! Все работает как надо, документация понятная. Установил за 5 минут. Рекомендую всем!',
        ...
        },
        {
            ...
            rating: 4,
            comment:
                'Хороший функционал, но хотелось бы больше настроек для кастомизации интерфейса.',
        ...
        },
        {
            ...
            rating: 5,
            comment:
                'Просто бомба! Поддержка отвечает быстро, все проблемы решаются моментально.',
